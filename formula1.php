...
<head>
    ...
    <title><?php echo isset($tituloPagina) ? $tituloPagina : "GRID&GOL - Fórmula 1"; ?></title>
...
<header>
    ...
    <nav>
        ...
        <a href="index.php?url=formula1" style="color: var(--primary);">Fórmula 1</a>
...
<section class="hero-slider">
    <div class="slide active" style="background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.6)), url('assets/img/banner-formula1.jpg');">
        <div class="hero-content">
            <h1>Alta Velocidade</h1>
            <p>Veste a paixão pelas pistas com as coleções oficiais da Fórmula 1.</p>
        </div>
    </div>
</section>

<main class="container">
    <h2 class="section-title">Coleção Fórmula 1</h2>
    ...
    <div class="product-grid">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        <span class="product-category">
                            <?php echo htmlspecialchars($produto['nome_marca'] ?? 'Scuderia'); ?>
                        </span>
        ...
        <?php else: ?>
            <div style="grid-column: 1 / -1; text-align: center; padding: 40px; color: var(--gray);">
                ...
                <p>Nenhum produto de Fórmula 1 disponível no momento.</p>
            </div>
        <?php endif; ?>
    </div>
</main>
