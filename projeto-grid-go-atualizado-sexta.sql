...
REPLACE INTO `cliente` (`id_cliente`, `nome`, `email`, `senha`, `telefone`, `endereco`, `data_cadastro`, `foto`) VALUES
	(1, 'HeMan', 'eutenhoaforca@eternia.com', '$2y$10$SnCaJnBe9IfP7xjfv6uqEOIMLRO74sB9eC2wtdIKKJbxPA63RqfGC', '219744343423', 'Rua greyskull', '2026-06-16 02:29:56', 'assets/img/avatars/avatar_1_1781825129.png');
...
-- Copiando dados para a tabela projeto_grid_go.pedido: ~5 rows (aproximadamente)
REPLACE INTO `pedido` (`id_pedido`, `data_pedido`, `valor_total`, `status`, `id_cliente`) VALUES
	(1583, '2026-06-18 02:37:16', 604.99, 'Pago', 1),
	(7988, '2026-06-18 04:08:28', 399.99, 'Pago', 1),
	(8495, '2026-06-18 04:18:07', 399.99, 'Pago', 1),
	(9759, '2026-06-18 23:49:24', 399.99, 'Pago', 1),
	(9978, '2026-06-19 00:05:50', 549.99, 'Pago', 1);
...
REPLACE INTO `produto` (`id_produto`, `nome`, `descricao`, `preco`, `estoque`, `imagem`, `id_categoria`) VALUES
	...
	(2, 'formula 1', 'teste', 150, 20, 'f339644109b1679af020606d3b690db6.jpg', 2);
